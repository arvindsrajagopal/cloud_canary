...
class SpecificationCoverageTests(unittest.TestCase):
    ...
    def test_liveness_phase_is_split_by_ownership_boundary(self):
        ...
        self.assertEqual([51, 53], tasks["R93"]["criteria_range"])
        ...
        self.assertIsNone(tasks["R98"]["criteria_range"])
        self.assertEqual(["R95"], tasks["R96"]["depends_on"])
        self.assertEqual(["R96"], tasks["R97"]["depends_on"])
        self.assertEqual(["R97"], tasks["R98"]["depends_on"])
        self.assertEqual(["R98"], tasks["R93"]["depends_on"])
        self.assertEqual(["R93"], tasks["R99"]["depends_on"])
        ...
        self.assertEqual(["R52"], tasks["R53"]["depends_on"])
        self.assertEqual([61, 62], tasks["R53"]["criteria_range"])
        self.assertEqual(["R53"], tasks["R54"]["depends_on"])
        self.assertEqual([63, 64], tasks["R54"]["criteria_range"])
        self.assertEqual(["R54"], tasks["R55"]["depends_on"])
        self.assertEqual([65, 65], tasks["R55"]["criteria_range"])
        ...
        self.assertEqual(["R56"], tasks["R102"]["depends_on"])
        self.assertIsNone(tasks["R102"]["criteria_range"])
        self.assertEqual(["R102"], tasks["R57"]["depends_on"])
